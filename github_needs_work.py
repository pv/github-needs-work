...
<body>
  ...
  <p>Same as <a href="https://github.com/{{project}}/pulls?q=is%3Apr+label%3A{{label_needs_champion}}">this github search</a>, with updated PRs excluded and WIPs included.</p>
...
def main():
    ...
    if lock.acquire(block=False):
        try:
            ...
            try:
                process(pull_cache, args.project, args.label_needs_work, args.label_needs_decision, args.label_needs_champion)
            finally:
                pull_cache.save()
        finally:
            lock.release()
